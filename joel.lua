...
poinT = Tunnel.getInterface("bdl_toggle")

vSERVER = Tunnel.getInterface("bdl_toggle")
...
RegisterNetEvent('bdl:weaponsRemove')
AddEventHandler('bdl:weaponsRemove',function()
	local ped = PlayerPedId()
